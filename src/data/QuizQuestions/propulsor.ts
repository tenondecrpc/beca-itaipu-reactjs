...
En 1858, varios compatriotas dejaron Paraguay, con el compromiso de que, a su regreso, desarrollarían e implementarían lo aprendido en beneficio del país y su relacionamiento con los países vecinos; así, los "Becarios de López" serían los artifices del proceso de modernización del país.

Los primeros becarios fueron a Gran Bretaña, los mismos fueronseleccionados del Aula de Filosofía y asumieron el compromiso de ir a prepararse para la carrera diplomática; entre ellos: Juan Crisóstomo Centurión, Gerónimo Pérez, Cándido Bareiro, Andrés Maciel y Gaspar López jóvenes que adquirieron una vasta cultura general y una eficiente formación jurídica. Bareiro llegó a ser Presidente de la República en el año 1878 y publicó cuatro volúmenes de "Memorias", de extraordinaria importancia en la historiografía paraguaya, una novela y diversos artículos, estudios y ensayos.
